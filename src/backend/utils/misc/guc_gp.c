...
static const struct config_enum_entry gg_topology_source_options[] = {
	{"catalog", GG_TOPOLOGY_SOURCE_CATALOG},
	{"file", GG_TOPOLOGY_SOURCE_FILE},
	{NULL, 0}
};
...
struct config_int ConfigureNamesInt_gp[] =
{
...

	{
		{"gp_max_partition_level", PGC_SUSET, PRESET_OPTIONS,
			gettext_noop("Sets the maximum number of levels allowed when creating a partitioned table using Greengage classic syntax."),
...

	{
		 ...
		 * removes the motion under modifytable plannode by the PR: https://github.com/GreengageDB/greengage/pull/9183
...
struct config_enum ConfigureNamesEnum_gp[] =
{
	...
	{
		{"gg_topology_source", PGC_POSTMASTER, PRESET_OPTIONS,
			...
			gettext_noop("\"catalog\" is the shared gp_segment_configuration, the "
						 "default. \"file\" is $PGDATA/gg_topology, which is not "
		...
		&gg_topology_source,
		GG_TOPOLOGY_SOURCE_CATALOG, gg_topology_source_options,
		NULL, NULL, NULL
	},
