...
DECLARE_UNIQUE_INDEX(gp_segment_config_content_preferred_role_index, 7139, on gp_segment_configuration_internal using btree(content int2_ops, preferred_role char_ops));
#define GpSegmentConfigContentPreferred_roleIndexId	7139
DECLARE_UNIQUE_INDEX(gp_segment_config_dbid_index, 7140, on gp_segment_configuration_internal using btree(dbid int2_ops));
